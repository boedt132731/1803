...
#**************************************************
#echo "从真机copy软件包："
#scp 192.168.4.254:/var/www/html/software/lnmp_soft/pssh-2.3.1-5.el7.noarch.rpm /opt
#scp 192.168.4.254:/var/www/html/software/lnmp_soft.tar.gz /opt
tar -xf /opt/lnmp_soft
#输入当前eth0 IP 地址
